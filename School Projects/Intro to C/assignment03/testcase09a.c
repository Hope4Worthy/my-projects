...
// ===========================
// assignment03: testcase09a.c
// ===========================
// This test case calls your feed_glowworm() function. If that function works correctly, then the
// output produced by this program will match the output specified in sample_output/output09a.txt.
...
int main(void)
{
	...
	// This should cause the glowworm to grow.
